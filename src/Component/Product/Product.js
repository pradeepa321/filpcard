        ...
        <div className='row'>
          ...
          <div className='product-range'>
             ...
             <div className='product-fil'>
               <h1>Fliter</h1>
               <h2 className='clr-btn'>CLEAR ALL</h2>
         ...
         {option}
          ...
          <div className='col-10'>
            <div className='product'>
             ...
             <h2>Monitor Headphones<span>(Showing 1 - 19 products of 19 products)</span></h2>
             <ul>
              <li>Sort By</li>
              <li>Popularity</li>
               ...
               {card.map((value,index) => {
                 return( <div className='col-3' key={index}>
                  <Card sx={{ maxWidth: 380 }} >
                   ...
                   <img src={value.image} width="100%" height="400px"/>
                   ...
                   <CardContent>
                     ...
                     <Typography variant="body2" color="text.secondary" className='amount'>
                       ...
                       <p className='amount1'><Icon icon="material-symbols:currency-rupee-rounded" width="15" height="15" />{value.offer}</p><del></del>
                      <h4>59% of</h4>
                     </Typography>
